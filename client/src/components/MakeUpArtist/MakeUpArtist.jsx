import MakeUp1 from '../../assets/MakeUp1.webp';
import ServicesCard from './ServicesCard';
import MakeUp2 from '../../assets/MakeUp2.webp';
import MakeUp3 from '../../assets/MakeUp3.webp';
import MakeUp4 from '../../assets/MakeUp4.webp';
...
import MakeUp13 from '../../assets/MakeUp13.jpg';
...
function MakeUpArtist() {
  return (
    <div>
      <div className='py-6 px-20 flex justify-between align-middle fixed top-12 right-0 left-0 bg-slate-100'>
        
        <p className='text-[24px] font-light'><span className='font-normal'>ROWEN NIKEL </span>|MAKEUP ARTIST</p>
      ...
      <div className='mt-34'>
        <img src={MakeUp1} alt='image' />
      </div>
      <div className='bg-red-200 text-center'>
        <EditText
        className='text-white text-[130px] m-0 p-0'
        name='textbox3'
        defaultValue='Kiss & Makeup'
        editButtonProps={{ style: { marginLeft: '5px', width: 16, background: 'none' } }}
        showEditButton
        />
        <EditText
        className='px-72'
        ...
        free to drag and drop me anywhere you like on your page. I’m a great place for you to 
        tell a story and let your users know a little more about you."
        
        />
      </div>
      <div className='bg-red-200 p-10 z-9'>
        <h3 className='text-[42px] tracking-wide text-white text-center'>SERVICES</h3>
        <div className='flex justify-center gap-3 pt-5'>
          <ServicesCard url={MakeUp3} service="EVENTS" />
          <ServicesCard url={MakeUp2} service="CREATIVE" />
          <ServicesCard url={MakeUp4} service="FASHION" />
        </div>
      </div>
      <div className='bg-green-950'>
        <h3 className='text-[42px] text-white text-center tracking-wide py-20 bg-fixed z-10'>PORTFOLIO</h3>
        <div className='grid md:grid-cols-3 grid-cols-2 gap-2 px-40 pb-20'>
          <img src={MakeUp5} />
          <img src={MakeUp6} />
          <img src={MakeUp7} />
          <img src={MakeUp8} />
